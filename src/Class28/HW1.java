...
public class HW1 {
    ...
    getQuote and cancelInsurance. Create 3 subclasses Car, Pet, Health. Car class has it’s own attribute as carModel
     and Class Pet has petType attribute. Create 3 objects of the sub classes and store them in ArrayList. Using for
...
abstract class Insurance{
    ...
    class Car extends Insurance{ //it  gives an error so implement the method in order to override because the Insurance class is abstract
    String carModel;
